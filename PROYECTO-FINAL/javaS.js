...
//creando la clase Stack, la cual usaremos para crear variables en forma de pilas
class Stack{

    constructor(){
        this.array =[];//aqui indicamos que todas las pilas que genere se crearan en forma de arreglo
    };
    ...
    pop(){
        ...
        return this.array.pop();//con this hacemos referencia a mi pila de Stack que contiene el metodo pop()
...
var t = new Stack(); //creamos una variable "t" que sera mi pila y pertenecera ami clase Stack ederando los metodos de dicha clase
...
//variable que usaremos para almacenar mas adelante los valores que no sera ceros y se encuentre una posicion adelante de un valor que si sea cero
var acum=0;

//variable que usamos mas adelante para almacenar el valor 0 encontrado en mi pila
var acumcero =0;
...
//counter nos sirve para indicarle al ciclo for cuantas veces debe de etirar(repetirse)
